class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta:- O que é que é tão frágil que, só de mencionar se quebra?" );
    ...
    this.option1.html("1: A mentira" );
    this.option1.position(150, 120);
    this.option2.html("2: O silêncio" );
    this.option2.position(150, 140);
    this.option3.html("3: A verdade" );
    this.option3.position(150, 160);
    this.option4.html("4: Vidro" );
